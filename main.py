...
#高压涡轮的出口参数
eta_h = eta_mh * eta_th
pi_h = (1 - l_ch * w_in / (eta_h * c_pg * t_t4)) ** (-(k_g / (k_g - 1)))
print(1 - l_ch * w_in / (eta_h * c_pg * t_t4))
print("pi_h = ", pi_h)

p_t5 = p_t4 / pi_h #高压涡轮出口总压
t_t5 = t_t4 - t_t4 * eta_th * (1 - 1 / (pi_h ** ((k_g -1) / k_g)))#高压涡轮出口总温
print("t_t5 = ", t_t5)

#低压涡轮的出口系数
eta_l = eta_ml * eta_tl
pi_l = (1 / (1 - l_cl * w_out /(eta_l * c_pg * t_t5))) ** ((k_g -1) / k_g)
print(1 - l_cl * w_out / (eta_l * c_pg * t_t5))
print(pi_l)
p_t6 = p_t5 / pi_l #低压涡轮出口总压
print(p_t6)
t_t6 = t_t5 - t_t5 * eta_th * (1 - 1 / (pi_l ** ((k_g -1) / k_g)))#低压涡轮出口总温
