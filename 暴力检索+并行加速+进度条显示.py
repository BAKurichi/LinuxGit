...
def evaluate_combo(params):
    ...
    try:
        ...
        error = (0.01*(thrust - target_thrust)) ** 2 + (1000 * (sfc - target_sfc)) ** 2
...
# --- 搜索空间定义 ---
bypass_range = np.arange(3.8, 5.5 + 0.01, 0.03)
pi_cl_range = np.arange(2.5, 3.4 + 0.01, 0.03)
pi_ch_range = np.arange(7.0, 8.9 + 0.01, 0.03)
